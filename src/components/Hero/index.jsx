...
function Hero() {
  ...
  return (
    <header className="bg-buttonBlue p-4 pt-[5.6rem]">
      <div className="max-w-[133.2rem] mx-auto">
        ...
        <h3 className="text-center text-[3.6rem] mt-[4rem] sm:mt-[0rem] sm:mb-[2.6rem] max-w-[35rem] mx-auto">
        ...
        <div className="flex items-center justify-between max-w-[56.6rem] mx-auto gap-[1.5rem] mb-[0.9rem]">
          ...
          <h5 className="text-[3.6rem] leading-[4.388rem]">Only $75</h5>
          <div className="max-w-[17.6rem] w-full h-[0.1rem] bg-text-dark"></div>
        </div>
        <div className="flex items-center flex-col sm:flex-row justify-center w-full relative">
          ...
          <div>
            ...
            <p className="text-[3.2rem] text-center max-w-[42.8rem] leading-[3.901rem]">
        ...
        <div className="flex flex-col sm:flex-row items-start gap-[4rem] sm:items-center justify-between bg-lightGray rounded-[3rem] sm:rounded-[11.9rem] mt-[10rem] px-[3rem] sm:px-[9.8rem] py-[4.8rem]">
          <div className="flex items-center gap-[4.6rem]">
            <img
              src={trustPilotLogo}
              alt="Trustpilot"
              className="h-auto w-[19.1rem]"
            />
            <div>
              <img
                src={ratingImg}
