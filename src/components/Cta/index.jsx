  ...
  return (
    <section className="p-4 pt-[5.6rem] mt-[10rem] pb-[13rem]">
      <div className="max-w-[133.2rem] mx-auto">
        <div className="border-[0.1rem] border-black p-[4rem] sm:py-[8.1rem] sm:px-[15.6rem] gap-[7.8rem] rounded-[3rem] sm:rounded-[20rem] flex flex-col sm:flex-col items-center justify-between w-full">
          <h4 className="max-w-[55.3rem] text-[4.8rem] leading-[5.851rem]">
